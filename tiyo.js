 // Counter Animation for Stats
        ...
        function createSlideshow() {
            ...
            // Remove existing content but keep arrows
            const existingSlides = container.querySelectorAll('.slide-media');
        ...
        function goToSlide(n) {
            const slides = document.querySelectorAll('#slideshowContainer .slide-media');
            const dots = document.querySelectorAll('#slideNav .modal-dot');
